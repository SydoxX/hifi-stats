...
function queryFewestUsers($sql, $result, $mysqli) {
  ...
  if ($result->num_rows > 0) {
    ...
    $response->{'fewestUsersCount'} = (integer)$count['userCount'];
  } else {
    respond404AndExit();
  }
}
...
function queryMostUsers($sql, $result, $mysqli) {
  ...
  if ($result->num_rows > 0) {
    ...
    $response->{'mostUsersCount'} = (integer)$count['userCount'];
  } else {
    respond404AndExit();
  }
}
...
function queryFewestDomains($sql, $result, $mysqli) {
  ...
  if ($result->num_rows > 0) {
    ...
    $response->{'fewestDomainsCount'} = (integer)$count['domainCount'];
  } else {
    respond404AndExit();
  }
}
...
function queryMostDomains($sql, $result, $mysqli) {
  ...
  if ($result->num_rows > 0) {
    ...
    $response->{'mostDomainsCount'} = (integer)$count['domainCount'];
  } else {
    respond404AndExit();
  }
}
